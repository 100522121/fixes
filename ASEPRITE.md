...
1. Create a `C:\Ninja` path instead of `C:\Ninja\ninja.exe` (also, delete the previously created path)

2. Additionally, if the issue has not been solved, try: `ninja -f C:\Ninja\ninja.exe`.
